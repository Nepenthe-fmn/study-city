<template>
<!--  <div class="success" v-show="show_page">-->
  <div class="success">
    <Header/>
    <div class="main">
        <div class="title">
<!--          <img src="../../static/images/right.svg" alt="">-->
        ...
        <div class="order-info">
            ...
            <p class="info2"><b>付款金额：</b><span >{{order_info.real_price}}</span></p>
            <p class="info3"><b>课程信息：</b>
              <router-link to="`/course/${course.course._id}`" :key="key" v-for="(course,key) in order_info.course_list">《{{course.course_name}}》</router-link>
            </p>
        </div>
