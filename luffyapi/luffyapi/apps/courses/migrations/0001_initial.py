# Generated by Django 2.2 on 2020-09-24 09:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateField(auto_now_add=True, verbose_name='发布日期')),
                ('courses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chapters', to='courses.Course', verbose_name='课程名称')),
            ],
            options={
                'verbose_name': '课程章节',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lesson_list', to='courses.Course', verbose_name='课程')),
            ],
            options={
                'verbose_name': '课程课时',
